            ...
            <div>
              ...
              <div className="mt-4 flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <a href="mailto:ahujayash450@gmail.com" className="text-white hover:text-neon transition-colors">ahujayash450@gmail.com</a>
                </div>
                <div className="flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-neon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span className="text-white">+91 9650063563</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-neon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="flex gap-3">
                    <a href="https://linkedin.com/in/yashahuja" target="_blank" rel="noopener noreferrer" className="text-white hover:text-neon transition-colors">LinkedIn</a>
                    <span className="text-secondary">|</span>
                    <a href="https://github.com/yashahuja" target="_blank" rel="noopener noreferrer" className="text-white hover:text-neon transition-colors">GitHub</a>
                  </div>
                </div>
              </div>
            </div>
